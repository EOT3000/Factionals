...
import fly.factions.impl.commands.faction.region.member.RegionMemberCommand;
...
public class RegionCommand extends CommandDivision {
    public RegionCommand() {
        ...
        addHelpEntry("/f region member", "View region member commands");
        ...
        addSubCommand("member", new RegionMemberCommand());
    }
}
